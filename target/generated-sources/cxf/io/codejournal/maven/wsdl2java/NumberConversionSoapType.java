...
public interface NumberConversionSoapType {
    ...
    @RequestWrapper(localName = "NumberToWords", targetNamespace = "http://www.dataaccess.com/webservicesserver/", className = "io.codejournal.maven.wsdl2java.NumberToWords")
    @ResponseWrapper(localName = "NumberToWordsResponse", targetNamespace = "http://www.dataaccess.com/webservicesserver/", className = "io.codejournal.maven.wsdl2java.NumberToWordsResponse")
    ...
    @RequestWrapper(localName = "NumberToDollars", targetNamespace = "http://www.dataaccess.com/webservicesserver/", className = "io.codejournal.maven.wsdl2java.NumberToDollars")
    @ResponseWrapper(localName = "NumberToDollarsResponse", targetNamespace = "http://www.dataaccess.com/webservicesserver/", className = "io.codejournal.maven.wsdl2java.NumberToDollarsResponse")
